...
var installModule = function installModule(_ref, notifyMode) {
  ...
  if (success) stopSpinner(spinner, message, "green", notifyMode);else stopSpinner(spinner, "".concat(name, " ").concat(colors.yellow("installation failed")), "yellow", notifyMode);
};
/* is scoped module? */
